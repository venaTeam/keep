...
2. **Real-Time Alerts**: Alerts arrive instantly via Server-Sent Events (SSE). The server notifies the browser, which retrieves and processes new alerts immediately.
