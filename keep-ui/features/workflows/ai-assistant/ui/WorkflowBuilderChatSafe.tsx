...
import { type WorkflowBuilderChatProps } from "./WorkflowBuilderChat";

const WorkflowBuilderChat = dynamic(
  () => import("./WorkflowBuilderChat").then((mod) => mod.WorkflowBuilderChat),
  {
    ssr: false,
    loading: () => (
      <div className="flex flex-col items-center justify-center h-full">
        <SparklesIcon className="size-10 text-orange-500 animate-pulse" />
